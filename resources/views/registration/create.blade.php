...
<div class="pt-5 container-backgroud background-cover container-backgrond-city background-fixed d-flex align-items-center">
    ...
    <h1 class="text-right py-3 pr-0 font-weight-light big-size-font color-black mx-auto">Register</h1>
    <form name="register" method="post" action="/articles" class="w-75 ml-auto">
        {{ csrf_field() }}
